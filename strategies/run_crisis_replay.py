"""
Run the crisis replay suite for a supported strategy key.
...
def main() -> None:
    strategy_key_tuple = CrisisAnalyzer.supported_strategy_key_tuple()

    parser = argparse.ArgumentParser()
    parser.add_argument(
        'strategy_key',
        choices=strategy_key_tuple,
        help='Supported strategy key to replay across configured crisis windows.',
    )
    parser.add_argument(
        '--output-dir',
        default='results',
