"""
Beyond 60/40 inverse-volatility strategy with BTAL and an 8% volatility target.
...
STRATEGY_NAME_STR = "strategy_taa_beyond_6040_inverse_vol_cap_8_btal"
ASSET_TUPLE = ("VTI", "GLD", "TLT", "BTAL")
