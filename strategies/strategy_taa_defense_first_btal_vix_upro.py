...
BTAL_VIX_UPRO_CONFIG = DefenseFirstVixTrancheBtalConfig(fallback_asset="UPRO")
...
if __name__ == "__main__":
    ...
    strategy = DefenseFirstVixTrancheBtalStrategy(
        name="DefenseFirstTAAVixTranche_Btal_UPRO",
