"""
SPHB/SPLV 2-day canary with SSO as risk-on and IAU as risk-off.
...
DEFAULT_CONFIG = SphbSplvCanaryConfig(
    trade_symbol_str="SSO",
    risk_off_symbol_str="IAU",
)
...
def run_variant(
    ...
    return run_base_variant(
        ...
        strategy_name_str="strategy_mo_sso_sphb_splv_canary_iau",
    )
