"""
Monthly ATR-adjusted momentum rotation for point-in-time S&P 500 members.
...
__all__ = [
    "ATR_WINDOW_INT",
    "AtrNormalizedSp500Config",
    "AtrNormalizedSp500Strategy",
    "DEFAULT_CONFIG",
    "audit_pit_universe_df",
    "compute_radge_signal_tables",
    "get_atr_normalized_sp500_data",
    "get_monthly_decision_close_df",
    "map_month_end_decision_dates_to_rebalance_schedule_df",
]
...
class AtrNormalizedSp500Config(RadgeMomentumNdxConfig):
    indexname_str: str = "S&P 500"


DEFAULT_CONFIG = AtrNormalizedSp500Config()


class AtrNormalizedSp500Strategy(RadgeMomentumNdxStrategy):
    """Canonical S&P 500 preset for the ATR-adjusted monthly rotation."""


def get_atr_normalized_sp500_data(
    config: AtrNormalizedSp500Config = DEFAULT_CONFIG,
...
if __name__ == "__main__":
    ...
    pricing_data_df, universe_df, rebalance_schedule_df = get_atr_normalized_sp500_data(config)

    strategy = AtrNormalizedSp500Strategy(
        name="strategy_mo_atr_normalized_sp500",
