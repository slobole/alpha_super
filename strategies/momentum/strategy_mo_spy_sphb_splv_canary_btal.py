"""
SPHB/SPLV 2-day canary with BTAL as the risk-off sleeve.
...
DEFAULT_CONFIG = SphbSplvCanaryConfig(risk_off_symbol_str="BTAL")
...
def run_variant(
    ...
    return run_base_variant(
        ...
        strategy_name_str="strategy_mo_spy_sphb_splv_canary_btal",
    )
