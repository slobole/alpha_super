"""
SPHB/SPLV 2-day canary with SSO as risk-on and cash as risk-off.
...
DEFAULT_CONFIG = SphbSplvCanaryConfig(trade_symbol_str="SSO")
...
def run_variant(
    ...
    return run_base_variant(
        ...
        trade_symbol_str=DEFAULT_CONFIG.trade_symbol_str,
        risk_off_symbol_str=DEFAULT_CONFIG.risk_off_symbol_str,
        strategy_name_str="strategy_mo_sso_sphb_splv_canary",
    )
