"""
SPHB/SPLV 2-day canary with IAU as the gold risk-off sleeve.
...
DEFAULT_CONFIG = SphbSplvCanaryConfig(risk_off_symbol_str="IAU")
...
def run_variant(
    ...
    return run_base_variant(
        ...
        strategy_name_str="strategy_mo_spy_sphb_splv_canary_iau",
    )
