...
class DV2VolSizedStrategy(DVO2Strategy):
    ...
    def __init__(
        ...
        self.volatility_field_str = f"volatility_{self.volatility_lookback_int}"
    ...
    def compute_signals(self, pricing_data_df: pd.DataFrame) -> pd.DataFrame:
        ...
        return pd.concat([signal_data_df, volatility_feature_df], axis=1).copy()
...
def run_variant(
    ...
    strategy_obj = DV2VolSizedStrategy(
        name=f"strategy_mr_dv2_vol_sized_{clean_mode_str}",
    ...
    # *** CRITICAL*** Keep full pre-start history for DV2 and volatility
