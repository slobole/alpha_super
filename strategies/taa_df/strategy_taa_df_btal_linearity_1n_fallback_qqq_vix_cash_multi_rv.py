"""
Defense First BTAL linearity 1/n fallback-QQQ variant with a multi-lookback VIX cash split.
"""
...
def run_variant(
    ...
    return run_linearity_1n_fallback_vix_cash_multi_rv_variant(
        strategy_name_str="strategy_taa_df_btal_linearity_1n_fallback_qqq_vix_cash_multi_rv",
