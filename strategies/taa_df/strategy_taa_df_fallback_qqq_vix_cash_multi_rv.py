"""
Defense First fallback-QQQ variant with a multi-lookback VIX cash split.
"""
...
try:
    ...
    from strategies.taa_df.strategy_taa_df_fallback_qqq import DEFAULT_CONFIG as BASE_CONFIG
    ...
    from strategy_taa_df_fallback_qqq import DEFAULT_CONFIG as BASE_CONFIG
...
def run_variant(
    ...
    return run_standard_fallback_vix_cash_multi_rv_variant(
        strategy_name_str="strategy_taa_df_fallback_qqq_vix_cash_multi_rv",
