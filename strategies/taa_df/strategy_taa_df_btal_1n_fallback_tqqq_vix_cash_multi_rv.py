"""
Defense First BTAL 1/n fallback-TQQQ variant with a multi-lookback VIX cash split.
"""
...
def run_variant(
    ...
    return run_standard_fallback_vix_cash_multi_rv_variant(
        strategy_name_str="strategy_taa_df_btal_1n_fallback_tqqq_vix_cash_multi_rv",
