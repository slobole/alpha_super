"""
Defense First fallback-SPY variant with a month-end VRP cash gate.
...
try:
    ...
    from strategies.taa_df.strategy_taa_df_fallback_spy import DEFAULT_CONFIG as BASE_CONFIG
    ...
    from strategy_taa_df_fallback_spy import DEFAULT_CONFIG as BASE_CONFIG
...
def run_variant(
    ...
    return run_standard_fallback_vix_cash_variant(
        strategy_name_str="strategy_taa_df_fallback_spy_vix_cash",
