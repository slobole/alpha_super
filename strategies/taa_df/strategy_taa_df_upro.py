"""
Defense First tactical allocation with a UPRO fallback sleeve.
...
Because UPRO starts trading on 2009-06-25, the execution dataset must satisfy:
...
upro_inception_date_str = "2009-06-25"

DEFAULT_CONFIG = DefenseFirstConfig(
    fallback_asset="UPRO",
    start_date_str=upro_inception_date_str,
)
...
def run_variant(
    ...
    return run_defense_first_variant(
        strategy_name_str="strategy_taa_df_upro",
        config=config,
