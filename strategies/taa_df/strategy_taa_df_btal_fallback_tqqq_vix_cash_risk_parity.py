"""
Defense First BTAL fallback-TQQQ VIX-cash variant with inverse-volatility
Risk Parity sizing.
...
try:
    ...
    from strategies.taa_df.strategy_taa_df_btal_fallback_tqqq_vix_cash import DEFAULT_CONFIG as BASE_CONFIG
    ...
    from strategy_taa_df_btal_fallback_tqqq_vix_cash import DEFAULT_CONFIG as BASE_CONFIG
...
STRATEGY_NAME_STR = "strategy_taa_df_btal_fallback_tqqq_vix_cash_risk_parity"
