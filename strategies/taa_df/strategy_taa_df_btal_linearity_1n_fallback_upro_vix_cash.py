"""
Defense First BTAL linearity 1/n fallback-UPRO variant with a month-end VRP cash gate.
...
def run_variant(
    ...
    return run_linearity_1n_fallback_vix_cash_variant(
        strategy_name_str="strategy_taa_df_btal_linearity_1n_fallback_upro_vix_cash",
