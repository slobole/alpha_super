"""
Defense First no-BTAL 1/n fallback-QLD variant with a month-end VRP cash gate.

Relative to `strategy_taa_df_1n_fallback_tqqq_vix_cash`, the only intended
changes are:

    old fallback asset = "TQQQ"
    new fallback asset = "QLD"
...
STRATEGY_NAME_STR = "strategy_taa_df_1n_fallback_qld_vix_cash"
QLD_FALLBACK_CONFIG = build_fallback_variant_config(
    NO_BTAL_1N_CONFIG,
    "QLD",
)
DEFAULT_CONFIG = build_vix_cash_variant_config(QLD_FALLBACK_CONFIG)
