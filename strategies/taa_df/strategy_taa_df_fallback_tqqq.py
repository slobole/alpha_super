"""
Defense First fallback variant.
...
try:
    from strategies.taa_df.strategy_taa_df import DEFAULT_CONFIG as BASE_CONFIG, get_defense_first_data
    ...
    from strategy_taa_df import DEFAULT_CONFIG as BASE_CONFIG, get_defense_first_data
...
def run_variant(
    ...
    return run_standard_fallback_variant(
        strategy_name_str="strategy_taa_df_fallback_tqqq",
