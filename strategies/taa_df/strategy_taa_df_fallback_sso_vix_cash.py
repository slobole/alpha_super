"""
Defense First fallback-SSO variant with a month-end VRP cash gate.

Relative to `strategy_taa_df_fallback_tqqq_vix_cash`, SSO changes both
the daily leverage target (3x to 2x) and the fallback index
...
try:
    ...
    from strategies.taa_df.strategy_taa_df_fallback_sso import DEFAULT_CONFIG as BASE_CONFIG
    ...
    from strategy_taa_df_fallback_sso import DEFAULT_CONFIG as BASE_CONFIG
...
STRATEGY_NAME_STR = "strategy_taa_df_fallback_sso_vix_cash"
