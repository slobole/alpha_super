...
`strategy_taa_defense_first.py` and mirrors the BTAL/SPY version, but redirects
rejected defensive slot weights into UPRO.
...
BTAL_UPRO_CONFIG = DefenseFirstConfig(
    defensive_asset_list=("GLD", "UUP", "TLT", "DBC", "BTAL"),
    fallback_asset="UPRO",
...
if __name__ == "__main__":
    ...
    strategy = DefenseFirstStrategy(
        name="DefenseFirstBTALUPROStrategy",
