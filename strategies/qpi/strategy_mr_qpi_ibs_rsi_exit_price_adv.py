"""
QPI long-only mean-reversion strategy with price / ADV entry filters and IBS / RSI2 exits.
...
class QPIIbsRsiExitPriceAdvStrategy(Strategy):
    """
    QPI stock pod with price / ADV20 / IBS entries and overbought IBS / RSI2 exits.
...
if __name__ == "__main__":
    ...
    strategy = QPIIbsRsiExitPriceAdvStrategy(
        name="strategy_mr_qpi_ibs_rsi_exit_price_adv",
