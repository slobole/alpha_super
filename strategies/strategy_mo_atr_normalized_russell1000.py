"""
Monthly ATR-adjusted momentum rotation for point-in-time Russell 1000 members.
...
__all__ = [
    "ATR_WINDOW_INT",
    "AtrNormalizedRussell1000Config",
    "AtrNormalizedRussell1000Strategy",
    "DEFAULT_CONFIG",
    "audit_pit_universe_df",
    "compute_radge_signal_tables",
    "get_atr_normalized_russell1000_data",
    "get_monthly_decision_close_df",
    "map_month_end_decision_dates_to_rebalance_schedule_df",
]
...
class AtrNormalizedRussell1000Config(RadgeMomentumNdxConfig):
    indexname_str: str = "Russell 1000"


DEFAULT_CONFIG = AtrNormalizedRussell1000Config()


class AtrNormalizedRussell1000Strategy(RadgeMomentumNdxStrategy):
    """Canonical Russell 1000 preset for the ATR-adjusted monthly rotation."""


def get_atr_normalized_russell1000_data(
    config: AtrNormalizedRussell1000Config = DEFAULT_CONFIG,
...
if __name__ == "__main__":
    ...
    pricing_data_df, universe_df, rebalance_schedule_df = get_atr_normalized_russell1000_data(config)

    strategy = AtrNormalizedRussell1000Strategy(
        name="strategy_mo_atr_normalized_russell1000",
