...
from strategies.strategy_mo_sp500_rotation import (
    DEFAULT_CONFIG,
    Sp500TrendRotationStrategy,
)


class Sp500TrendRotationWrapperTests(unittest.TestCase):
    ...
    def test_default_config_points_to_sp500_universe_and_spx_regime(self):
    ...
    def test_strategy_alias_reuses_weekly_rotation_engine_with_spx_regime(self):
        strategy = Sp500TrendRotationStrategy(
            name="Sp500RotationTest",
            benchmarks=["$SPX"],
