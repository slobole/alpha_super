...
from strategies.strategy_mr_qpi_ibs_rsi_exit import QPIIbsRsiExitStrategy


class QPIIbsRsiExitStrategyTests(unittest.TestCase):
    def make_strategy(self, **kwargs) -> QPIIbsRsiExitStrategy:
        base_kwargs = dict(
            name="QPIIbsRsiExitTest",
            benchmarks=[],
        ...
        return QPIIbsRsiExitStrategy(**base_kwargs)
    ...
    def test_get_opportunity_list_enforces_filters_and_ranking(self):
        strategy = self.make_strategy()
    ...
    def test_iterate_enters_highest_ranked_candidate_when_no_exit_is_triggered(self):
