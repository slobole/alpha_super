...
from strategies.taa_df.strategy_taa_df_btal_linearity import (
    ...
    compute_month_end_rank_weight_df_from_daily_linearity_score_df,
)
...
def test_compute_month_end_rank_weight_df_from_daily_linearity_score_df_uses_rank_slots():
    ...
    daily_linearity_score_df.loc[pd.Timestamp("2020-01-31"), :] = {
        "GLD": 0.50,
        "UUP": 0.40,
        "TLT": 0.30,
        "DBC": -0.20,
    ...
    daily_linearity_score_df.loc[pd.Timestamp("2020-02-28"), :] = -0.50
